...
require_once WP_THUMB_PATH . '/wpthumb.watermark.php';
require_once WP_THUMB_PATH . '/wpthumb.background-fill.php';
require_once WP_THUMB_PATH . '/wpthumb.crop-from-position.php';
require_once WP_THUMB_PATH . '/wpthumb.shortcodes.php';
...
function wpthumb_post_image( $null, $id, $args )
{
    ...
    // Check if $args is a WP Thumb argument list, or a native WordPress one
